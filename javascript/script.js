...
function updateTimer() {
  const targetDate = new Date("september 19, 2026 21:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const phoneNumber1 = '542634382279'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '542634900998'; // Número para el primer botón
  const recipientNumber2 = '542634382279'; // Número para el segundo botón
